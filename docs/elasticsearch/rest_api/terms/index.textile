...
| @fields@ | A comma separated list of fields to get the terms for, *required*.|
...
| @fromInclusive@ | Should the first from (if set) be inclusive or not. Defaults to @true@ |
...
| @termsAsArray@ | Controls the JSON response format, if the terms should be the object name, or exist within an array. Defaults to @true@. |
