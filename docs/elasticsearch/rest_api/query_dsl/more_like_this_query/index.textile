...
docBreadcrumb = [
    ...
    ["rest_api", "REST API"],
    ["query_dsl", "Query DSL"],
    ["more_like_this_query", "More Like This Query"],
];
</script>

h1. More Like This Query
...
|@boost_terms@|Whether to boost terms in query based on "score" or not. Defaults to @false@.|
|@boost_terms_factor@|Sets the boost factor to use when boosting terms. Defaults to @1@.|
