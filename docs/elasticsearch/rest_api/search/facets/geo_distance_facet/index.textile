---
layout: doc_es
title: ElasticSearch Docs | REST API | Search | Facets | Geo Distance Facet
---
...
docBreadcrumb = [
    ...
    ["search", "Search"],
    ["facets", "Facets"],
    ["geo_distance_facet", "Geo Distance Facet"],
];
</script>

h1. Geo Distance Facet
...
p. he facet does not require the @geo_point@ type to be set. It assumes that the location object indexed includes a lat and lon numeric values. The @geo_point@ type follows these rules and allows for more flexible indexing options / structure, but is not required.
