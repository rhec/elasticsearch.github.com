---
layout: doc_es
title: ElasticSearch Docs | JSON API
---
...
p. This section describes the APIs ElasticSearch exposes over HTTP using JSON. The following are the main APIs one would need in order to get started with ElasticSearch:
...
p. There is also an evolving "Administration JSON API":admin.
