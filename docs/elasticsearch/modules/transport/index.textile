...
|@transport.tcp.connect_timeout@|The socket connect timeout setting (in time setting format). Defaults to @1s@.|
|@transport.tcp.connections_per_node@|The number of open connections from this node to another node. Defaults to @5@|
