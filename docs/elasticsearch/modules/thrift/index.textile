...
The thrift "schmea":http://github.com/elasticsearch/elasticsearch/blob/master/plugins/transport/thrift/elasticsearch.thrift can be used to generate thrift clients.
