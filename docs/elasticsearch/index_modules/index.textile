...
|"mapper":mapper|The mapper module acts as a registry for the type mapping definitions added to an index using the "create mapping":/docs/elasticsearch/rest_api/admin/indices/create_mapping.|
|"merge":merge|The merge module allow to configure both the "merge policy":merge/policy and "merge scheduler":merge/scheduler of a specific shard index.|
