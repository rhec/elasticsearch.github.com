...
|"mapper":mapper|The mapper module acts as a registry for the type mapping definitions added to an index using the "create mapping":/docs/elasticsearch/json_api/admin/indices/create_mapping.|
