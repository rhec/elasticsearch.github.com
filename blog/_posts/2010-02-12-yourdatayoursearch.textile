...
p. But, as mentioned before, ElasticSearch *understands* the structure of the JSON book, which means we can execute the following search to find all the books that were authored by someone with firstName of Jack: @localhost:9200/amazon/book/_search?q=author.firstName:Jack@.
